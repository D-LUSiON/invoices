...
function patchWebpackConfig(config, options) {
    ...
    config.externals = {
        ...
        rxjs: 'rxjs',
        tslib: 'tslib',
        'ng-zorro-antd/menu': 'nz.menu',
        'ng-zorro-antd/collapse': 'nz.collapse',
        'ng-zorro-antd/tree': 'nz.tree',
        'ng-zorro-antd/dropdown': 'nz.dropdown',
        'ng-zorro-antd/tabs': 'nz.tabs',
        'ng-zorro-antd/empty': 'nz.empty',
        'ng-zorro-antd/button': 'nz.button',
        'ng-zorro-antd/icon': 'nz.icon',
        '@ngx-translate/core': 'ng.translate',
    };
    if (sharedLibs) {
